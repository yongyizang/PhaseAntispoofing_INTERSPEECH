...
def main(args: argparse.Namespace) -> None:
    ...
    trn_loader, dev_loader, eval_loader = get_loader(
        database_path, args.seed, args.pertubate_prefix, config)
...
def get_loader(
    ...
    train_set = Dataset_ASVspoof2019_train(list_IDs=file_train,
                                           ...
                                           pertubate_prefix=pertubate_prefix)
    gen = torch.Generator()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--pertubate_prefix",
                        type=str,
                        default="",
                        help="prefix for pertubated files (default: empty string)")
